## QEUR21_MZPROT8: 閑話休題～バージョンアップ中 (トライアルD)

## ～　「見えること」は大事デス　～

### ・・・　前回のつづきです　・・・

D先生 : “ランダム命令でコマが動いているんですが、様子を見れないのがつまらないですね。第三者からみると・・・。”

![imageRL6-9-1](https://reinforce.github.io/images/imageRL6-9-1.jpg) 

QEU:FOUNDER ; “じゃあ、ビデオ録画しましょうか。OpenCVのビデオ機能を使って・・・。”

![imageRL6-9-2](https://reinforce.github.io/images/imageRL6-9-2.jpg) 

D先生 : “いろいろな用途に使えるようですね。今回はpygameに使うだけで・・・。”

QEU：FOUNDER ; “それではPythonコードをドン！！録画機能以外は前回のプログラムとかわりません”
    ...
    def get_episode(self, iCnt_play):
        ...
        for iCnt_turn in range(NUMS_TURNS):
            ...
            if iCnt_turn == 0:
                fps = 12
                size = (640,640)
                file_path = "./test_maze.mp4"#导出路径
                fourcc = cv2.VideoWriter_fourcc('I','4','2','0')#不同视频编码对应不同视频格式（例：'I','4','2','0' 对应avi格式）
                My_video = cv2.VideoWriter( file_path, fourcc, fps, size )
...
QEU：FOUNDER ; “今回は、出力される動画のみを見ましょう・・・。”

![movieRL6-9-3](https://reinforce.github.io/images/movieRL6-9-3.mp4) 

D先生 ; “次はいよいよ、簡単な強化学習に行きましょうか。”
...
![imageRL6-9-4](https://reinforce.github.io/images/imageRL6-9-4.jpg) 

D先生: “検査が本格的に「品質保証」になるんだったら、Ix(なんだたっけ)O9001っていらなくなりますかねぇ？”

![imageRL6-9-5](https://reinforce.github.io/images/imageRL6-9-5.jpg) 

QEU:FOUNDER ; “いや？逆じゃね・・・？アレは、**「便益」を得られる**らしいし・・・。”

![imageRL6-9-6](https://reinforce.github.io/images/imageRL6-9-6.jpg) 

D部長: “**「可能性」**じゃないんですか？・・・というか、FOUNDERは「アンチ」でしたよね・・・。”
...
QEU:FOUNDER ： “**「顧客満足を向上させる機会が増える」**んじゃね？IXOって、**品質向上にとって効率のいい方法ではあるが、有効性の高い方法じゃない**んですよ。”

D先生: “それじゃ、もうだめじゃないですか。**IXOにおける有効性の問題はさんざん言われていた**ことですが・・・。”

QEU:FOUNDER ： “有効性の部分は外観検査自動機に負担させればいいんですよ・・・(笑)。”
