## QEUR21_2DMZ3:　 RT距離の代わりに・・・

## ～　簡単にやりましょう、物事は・・・　～

### ・・・　前回のつづきです　・・・

C部長 : “これ（↓）にRT距離を追加すると、もっと良くなるのかなぁ・・・。”

**（学習曲線）**

![imageRL4-4-1](https://reinforce.github.io/images/imageRL4-4-1.jpg)

**（パフォーマンス推移）**

![imageRL4-4-2](https://reinforce.github.io/images/imageRL4-4-2.jpg)

D先生 ： “これからは、画像認識以外ではRT距離を使わないって・・・。”

QEU;FOUNDER ： “**RT距離に近い考え方のメトリックスを新しく導入します**。つまり、こういう感じにルート（経路）を単位空間とし、計測対象として「ある座標」が与えられたときには最短になるユークリッド距離を出力します。”

![imageRL4-4-3](https://reinforce.github.io/images/imageRL4-4-3.jpg)

C部長 : “これは簡単です・・・。でも、こんなモノがRT距離の代替品になるの？”

![imageRL4-4-4](https://reinforce.github.io/images/imageRL4-4-4.jpg)

D先生 ： “もともとのRT距離はY1（感度）とY2（SN比）で構成されています。SN比と言ってはいるが、Y2はユーグリッド距離のことです・・・。”

![imageRL4-4-5](https://reinforce.github.io/images/imageRL4-4-5.jpg)

QEU:FOUNDER : “申し訳ないけど、Y1メトリックス（感度）ってあまり役に立ってないよね。じゃあ、**「Y2（SN比）だけで距離を作っちゃえ！」**という感じ・・・。”
...
# step3_dqn_maze_pyTorch(space_minRT).py
# step3 : DQN-Experience replay
# ---------------- 
# 数値計算のﾗｲﾌﾞﾗﾘ読み込み
import numpy as np
import pandas as pd
...
QEU:FOUNDER : “つづいて結果をドン！！前回の「６つのランドマーク」の結果と比較してください。

**（学習曲線）**

![imageRL4-4-6](https://reinforce.github.io/images/imageRL4-4-6.jpg)

**（パフォーマンス推移）**

![imageRL4-4-7](https://reinforce.github.io/images/imageRL4-4-7.jpg)

D先生 ： “すごく似た形だな・・・。一見すると、minRT距離には効果がないように見えます。

QEU:FOUNDER : “**Lossのグラフに注目してください。Y軸のスケールが全然ちがうでしょ？**”

D先生 ： “えっ？本当だ・・・。空間minRT距離を追加すると、Y軸のスケールが半分になっています。このグラフを見れば、学習加速の効果は一目瞭然です。でも・・・、どうして「空間（minRT）」なのですか？”

QEU:FOUNDER : “実はminRT法には「時間」もあるから・・・（笑）。この件は、次回に・・・。”

## ～　まとめ　～

QEU:FOUNDER ： “そうなのか・・・。新聞にはタイムスとポストがあるのか・・・。”

<iframe width="560" height="315" src="https://www.youtube.com/embed/beMVvgvWbhE" ti-tle="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; en-crypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

D先生 : “知らなかったんですか？”

![imageRL4-4-8](https://reinforce.github.io/images/imageRL4-4-8.jpg)

QEU:FOUNDER ： “そりゃ、そんなモン、ルXルリも知らんのに、小生が知るわけないわい。”

D先生 : “でも、タイムスって、FOUNDERが昔ファンだった、あの方（↓）も結構出ていたらしいですよ？”

![imageRL4-4-9](https://reinforce.github.io/images/imageRL4-4-9.jpg)

QEU:FOUNDER ： “A国の選挙の話を分かりやすく話してくれる人は、そうはいないですからね。”

D先生 : “いろんな情報が氾濫して、真偽がわかりません・・・。”

![imageRL4-4-10](https://reinforce.github.io/images/imageRL4-4-10.jpg)

QEU:FOUNDER ： “ほんとうに、よくわかりませんね・・・。”
